    ...
    return (
        <div>
          ...
          <div className="jumbotron" style={{height:"320px"}} style={{marginTop:"20px"}}>
            ...
            <a className="btn btn-primary btn-lg" href="https://github.com/cmausley" target="_blank" role="button">GitHub</a> <a className="btn btn-primary btn-lg" href="https://www.linkedin.com/in/christina-ausley/" target="_blank" role="button">LinkedIn</a>
            </div>
            </div>
            </div>
    );
