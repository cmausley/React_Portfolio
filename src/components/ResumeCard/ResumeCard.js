...
function ResumeCard() {
  return (
    <div>
      <div className="card" style={{marginTop: "10px", marginBottom: "10px", backgroundColor: "#e4f9f5"}}>
        ...
        <div className="card-body">
          ...
          <a href="https://drive.google.com/file/d/1qznh3fDubJI06Apr15DZU1f9SOgsKPfP/view?usp=sharing" style={{backgroundColor: "#30e3ca"}} target="_blank" className="btn btn-primary">
            Resume
          </a>
        </div>
      </div>
